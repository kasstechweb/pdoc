                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control py-4 @error('termination_date') is-invalid @enderror" id="termination_date" type="date" name="termination_date"  value="{{ $employee->termination_date  }}" required/>
